...
describe('Direwolf', function() {
  ...
  it
  ('should instantiate our good friend, Direwolf', function() {
  ...
  it
  ('should have a default home of Beyond the Wall', function() {
  ...
  it
  ('should be able to have other homes', function() {
  ...
  it
  ('should have a default size of massive', function() {
  ...
  it
  ('should be able to have another size', function() {
  ...
  it
  ('should instantiate our good friend, Stark', function() {
    var stark = new Stark();
  ...
  it
  ('should have a default home of Winterfell', function() {
    var stark = new Stark('Bran');
  ...
  it
  ('should start with no Starks to protect', function() {
    var direwolf = new Direwolf('Nymeria');
  ...
  it
  ('should be able to protect a Stark', function() {
  ...
  it
  ('should only be able to protect a Stark if direwolf and Stark locations match', function() {
    var direwolf = new Direwolf('Ghost');
  ...
  it
  ('should only be able to protect two Starks at a time', function() {
  ...
  it
  ('Stark should start off unsafe', function() {
  ...
  it
  ('should change house words once protected', function() {
